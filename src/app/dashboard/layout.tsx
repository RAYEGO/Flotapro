      ...
      <div className="mx-auto grid max-w-6xl grid-cols-1 gap-6 px-6 py-6 md:grid-cols-[220px_1fr]">
        <nav className="rounded-2xl bg-white p-4 shadow-sm ring-1 ring-black/5">
          <div className="space-y-1 text-sm">
            <Link className="flex items-center gap-2 rounded-lg px-3 py-2 text-zinc-900 hover:bg-zinc-50" href="/dashboard">
              <svg className="h-4 w-4 text-zinc-500" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
                <path d="M12 3.172 3 10.5V21a1 1 0 0 0 1 1h5v-7h6v7h5a1 1 0 0 0 1-1V10.5l-9-7.328Z" />
              </svg>
              <span>Resumen</span>
            </Link>
            <Link className="flex items-center gap-2 rounded-lg px-3 py-2 text-zinc-900 hover:bg-zinc-50" href="/dashboard/trucks">
              <svg className="h-4 w-4 text-zinc-500" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
            ...
            <Link className="flex items-center gap-2 rounded-lg px-3 py-2 text-zinc-900 hover:bg-zinc-50" href="/dashboard/drivers">
              <svg className="h-4 w-4 text-zinc-500" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
                <path d="M12 4a4 4 0 1 1 0 8 4 4 0 0 1 0-8Zm-7 15a7 7 0 0 1 14 0v1H5v-1Z" />
              </svg>
              <span>Choferes</span>
            </Link>
            <Link className="flex items-center gap-2 rounded-lg px-3 py-2 text-zinc-900 hover:bg-zinc-50" href="/dashboard/freights">
              <svg className="h-4 w-4 text-zinc-500" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
            ...
            <Link className="flex items-center gap-2 rounded-lg px-3 py-2 text-zinc-900 hover:bg-zinc-50" href="/dashboard/fuels">
              <svg className="h-4 w-4 text-zinc-500" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
            ...
            <Link className="flex items-center gap-2 rounded-lg px-3 py-2 text-zinc-900 hover:bg-zinc-50" href="/dashboard/maintenance">
              <svg className="h-4 w-4 text-zinc-500" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
